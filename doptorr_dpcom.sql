...
CREATE TABLE `additional_settings` (
  ...
  `free_subscr_item` int(100) NOT NULL,
  `free_subscr_space` varchar(500) DEFAULT NULL,
  `free_subscr_type` varchar(100) DEFAULT NULL,
  `free_subscr_price` float NOT NULL,
  `site_google_recaptcha` int(50) NOT NULL,
  `subscription_mode` int(50) NOT NULL,
  `free_subscription` int(50) NOT NULL,
  `payhere_mode` int(50) NOT NULL,
  `payhere_merchant_id` varchar(200) DEFAULT NULL,
  `payumoney_mode` int(50) NOT NULL,
  ...
  `show_extended_license` int(50) NOT NULL,
  `show_screenshots` int(50) NOT NULL,
  `show_video` int(50) NOT NULL,
  `show_moneyback` int(50) NOT NULL,
  `show_demo_url` int(50) NOT NULL,
  `show_free_download` int(50) NOT NULL,
  `show_flash_sale` int(50) NOT NULL,
  `show_tags` int(50) NOT NULL,
  `show_feature_update` int(50) NOT NULL,
  `show_item_support` int(50) NOT NULL,
  `show_refund_term` int(50) NOT NULL,
  `site_tawk_chat` text,
  `site_free_items_price` int(50) NOT NULL DEFAULT '1',
  `iyzico_api_key` varchar(500) DEFAULT NULL,
  `iyzico_secret_key` varchar(500) DEFAULT NULL,
  `iyzico_mode` int(50) NOT NULL,
  ...
  `refund_mode` int(11) NOT NULL,
  `image_quality` int(11) NOT NULL,
  `subscr_download_items` mediumint(9) NOT NULL,
  `upgrade_files` varchar(191) DEFAULT NULL,
  `ipay_mode` int(11) NOT NULL,
  ...
  `site_email_display` int(11) NOT NULL,
  `site_phone_display` int(11) NOT NULL,
  `site_address_display` int(11) NOT NULL,
  `site_url_rewrite` int(11) NOT NULL,
  `post_short_desc_limit` int(11) NOT NULL,
  `author_name_limit` int(11) NOT NULL,
  `item_name_limit` int(11) NOT NULL
...
CREATE TABLE `attributes` (
  ...
  `attr_category` int(100) NOT NULL,
...
CREATE TABLE `badges` (
  ...
  `author_sold_level_one` int(50) NOT NULL DEFAULT '0',
  `author_sold_level_two` int(50) NOT NULL DEFAULT '0',
  `author_sold_level_three` int(50) NOT NULL DEFAULT '0',
  `author_sold_level_four` int(50) NOT NULL DEFAULT '0',
  `author_sold_level_five` int(50) NOT NULL DEFAULT '0',
  `author_sold_level_six` int(50) NOT NULL DEFAULT '0',
  ...
  `author_collect_level_one` int(50) NOT NULL DEFAULT '0',
  `author_collect_level_two` int(50) NOT NULL DEFAULT '0',
  `author_collect_level_three` int(50) NOT NULL DEFAULT '0',
  `author_collect_level_four` int(50) NOT NULL DEFAULT '0',
  `author_collect_level_five` int(50) NOT NULL DEFAULT '0',
  `author_collect_level_six` int(50) NOT NULL DEFAULT '0',
  ...
  `author_referral_level_one` int(50) NOT NULL DEFAULT '0',
  `author_referral_level_two` int(50) NOT NULL DEFAULT '0',
  `author_referral_level_three` int(50) NOT NULL DEFAULT '0',
  `author_referral_level_four` int(50) NOT NULL DEFAULT '0',
  `author_referral_level_five` int(50) NOT NULL DEFAULT '0',
  `author_referral_level_six` int(50) NOT NULL DEFAULT '0',
...
INSERT INTO `category` (`cat_id`, `category_name`, `category_slug`, `category_status`, `menu_order`, `drop_status`) VALUES
(8, 'Scripts', 'Scripts', 1, 1, 'no'),
(9, 'Themes', 'Themes', 1, 2, 'no'),
(10, 'Plugins', 'Plugins', 1, 3, 'no'),
(11, 'Print', 'Print', 1, 5, 'no'),
(12, 'Graphics', 'Graphics', 1, 4, 'no'),
(13, 'Mobile Apps', 'Mobile-Apps', 1, 6, 'no'),
(14, 'Games', 'games', 1, 10, 'no');
...
(31, 41, 39, '4766', 41, 'unread', 'hi', '2021-09-20 06:18:22'),
...
CREATE TABLE `email_template` (
  ...
  `et_heading` text COLLATE utf8mb4_unicode_ci,
  `et_subject` text COLLATE utf8mb4_unicode_ci,
  `et_content` longtext COLLATE utf8mb4_unicode_ci,
...
CREATE TABLE `follow` (
  `fid` int(11) NOT NULL,
  `follower_user_id` int(200) NOT NULL,
  `following_user_id` int(200) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `items` (
  ...
  `item_token` varchar(100) NOT NULL,
  ...
  `item_category_parent` int(100) NOT NULL DEFAULT '0',
  ...
  `seller_refund_term` text,
  `seller_money_back` int(50) NOT NULL,
  `seller_money_back_days` int(50) NOT NULL,
  `compatible_browsers` varchar(10) DEFAULT NULL,
  `package_includes` varchar(10) DEFAULT NULL,
  `package_includes_two` varchar(10) DEFAULT NULL,
  `columns` varchar(10) DEFAULT NULL,
  `layout` varchar(10) DEFAULT NULL,
  `package_includes_three` varchar(10) DEFAULT NULL,
  `layered` varchar(10) DEFAULT NULL,
  `cs_version` varchar(10) DEFAULT NULL,
  `print_dimensions` varchar(10) DEFAULT NULL,
  `pixel_dimensions` varchar(10) DEFAULT NULL,
  `package_includes_four` varchar(10) DEFAULT NULL,
  `demo_url` varchar(800) DEFAULT NULL,
  `video_preview_type` varchar(50) DEFAULT NULL,
  `video_file` varchar(200) DEFAULT NULL,
  `video_url` varchar(200) DEFAULT NULL,
  `item_tags` text,
  `item_liked` int(11) DEFAULT '0',
  `item_views` int(200) NOT NULL,
  `free_download` int(11) NOT NULL,
  `item_featured` varchar(50) NOT NULL DEFAULT 'no',
  `item_sold` int(11) DEFAULT '0',
  `future_update` int(20) NOT NULL DEFAULT '0',
  `item_support` int(20) NOT NULL DEFAULT '0',
  ...
  `download_count` int(100) NOT NULL,
  `item_flash` int(50) NOT NULL DEFAULT '0',
  `item_flash_request` int(50) NOT NULL DEFAULT '0',
  `item_allow_seo` int(50) DEFAULT NULL,
...
INSERT INTO `items` (`item_id`, `user_id`, `item_token`, `item_name`, `item_slug`, `item_desc`, `item_shortdesc`, `item_thumbnail`, `item_preview`, `item_file`, `file_type`, `item_file_link`, `item_category`, `item_category_parent`, `item_category_type`, `item_type_cat_id`, `item_type`, `item_type_id`, `regular_price`, `extended_price`, `seller_refund_term`, `seller_money_back`, `seller_money_back_days`, `compatible_browsers`, `package_includes`, `package_includes_two`, `columns`, `layout`, `package_includes_three`, `layered`, `cs_version`, `print_dimensions`, `pixel_dimensions`, `package_includes_four`, `demo_url`, `video_preview_type`, `video_file`, `video_url`, `item_tags`, `item_liked`, `item_views`, `free_download`, `item_featured`, `item_sold`, `future_update`, `item_support`, `created_item`, `updated_item`, `download_count`, `item_flash`, `item_flash_request`, `item_allow_seo`, `item_seo_keyword`, `item_seo_desc`, `audio_file`, `drop_status`, `item_status`) VALUES
(76, 39, '9R4OHZdojfFJkDEFIsPfaoZKK', 'Cididunt ut labore et', 'cididunt-ut-labore-et', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam', 'Wed-Aug-18-2021-943-AM65807.jpg', 'Wed-Aug-18-2021-943-AM65807.jpg', 'Thu-Jul-8-2021-1008-AM58703.zip', 'file', NULL, '2', 8, 'subcategory', 'subcategory_2', 'scripts', '1', 25, 175, 'test', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', 'php files,php script', 1, 95, 1, 'no', 23, 1, 0, '2022-02-09 11:15:37', '2022-02-09 11:15:37', 0, 0, 0, 0, '', '', '', 'no', 0),
(77, 39, 'kKdlCXQte5LnE85SBatqSlpTo', 'Sectetur adipiscing elit', 'sectetur-adipiscing-elit', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam', 'Wed-Aug-18-2021-942-AM97017.jpg', 'Wed-Aug-18-2021-942-AM97017.jpg', 'Thu-Jul-8-2021-1009-AM26656.zip', 'file', NULL, '8', 8, 'category', 'category_8', 'scripts', '1', 47, 450, 'test', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'youtube', '', 'https://www.youtube.com/watch?v=C0DPdy98e4c', 'script,files,php script', 1, 67, 0, 'yes', 8, 0, 1, '2022-02-09 11:15:21', '2022-02-09 11:15:21', 0, 0, 1, 0, '', '', '', 'no', 0),
(78, 39, 'LJPEMB5p0VNFria7rMwvvt9St', 'Eiusmod tempor incididunt', 'eiusmod-tempor-incididunt', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam', 'Wed-Aug-18-2021-942-AM35583.jpg', 'Wed-Aug-18-2021-942-AM35583.jpg', 'Thu-Jul-8-2021-1010-AM84618.zip', 'file', NULL, '7', 9, 'subcategory', 'subcategory_7', 'themes', '2', 29, 219, 'test', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'mp4', '1608110697128.mp4', '', 'wordpress theme,wp themes,themes', 1, 115, 0, 'yes', 8, 1, 1, '2022-02-09 11:14:58', '2022-02-09 11:14:58', 0, 0, 1, 0, '', '', '', 'no', 0),
(79, 39, 'LilCB3uHFGeGxgCZgX2H8g2Ey', 'Ut labore et dolore magna', 'ut-labore-et-dolore-magna', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.', 'Wed-Aug-18-2021-942-AM11296.jpg', 'Wed-Aug-18-2021-942-AM11296.jpg', 'Thu-Jul-8-2021-1010-AM60913.zip', 'file', NULL, '10', 10, 'category', 'category_10', 'plugins', '3', 54, 539, 'test', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://test.com', 'youtube', '', 'https://www.youtube.com/watch?v=xcJtL7QggTI', 'plugin,wp plugin,custom plugin', 0, 46, 1, 'yes', 5, 1, 0, '2022-02-09 11:14:43', '2022-02-09 11:14:43', 0, 0, 0, 0, '', '', '', 'no', 0),
(80, 39, 'qNOMwcQde97WrD3SLjoRVpVGD', 'Adipiscing elit consectetur', 'adipiscing-elit-consectetur', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam', 'Wed-Aug-18-2021-941-AM54221.jpg', 'Wed-Aug-18-2021-941-AM54221.jpg', 'Thu-Jul-8-2021-1011-AM65719.zip', 'file', NULL, '40', 12, 'subcategory', 'subcategory_40', 'print', '4', 147, 359, '', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://test.com', '', '', '', 'psd,photoshop,illustration', 0, 64, 0, 'yes', 4, 1, 1, '2022-02-09 11:14:29', '2022-02-09 11:14:29', 0, 0, 1, 0, '', '', '', 'no', 0),
(81, 39, 'qvNQNRGUiWP0UOR2NPg1cw4BH', 'Sed do eiusmod tempor', 'sed-do-eiusmod-tempor', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.', 'Wed-Aug-18-2021-941-AM38402.jpg', 'Wed-Aug-18-2021-941-AM38402.jpg', 'Thu-Jul-8-2021-1011-AM18644.zip', 'file', NULL, '12', 12, 'category', 'category_12', 'graphics', '5', 26, 152, 'saa', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', 'illustration,graphics,psd', 0, 68, 1, 'yes', 1, 0, 0, '2022-02-09 11:14:12', '2022-02-09 11:14:12', 3, 0, 0, 0, '', '', '', 'no', 0),
(82, 39, '99eEe3cmGa8FRzyr9yvtdeuYQ', 'Lorem ipsum dolor', 'lorem-ipsum-dolor', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.', 'Wed-Aug-18-2021-941-AM62827.jpg', 'Wed-Aug-18-2021-941-AM62827.jpg', 'Thu-Jul-8-2021-1012-AM39708.zip', 'file', NULL, '13', 13, 'category', 'category_13', 'mobile-apps', '6', 35, 299, 'test', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', 'mobile app,apk files,android,ios app', 1, 144, 1, 'yes', 7, 1, 0, '2022-02-09 11:13:52', '2022-02-09 11:13:52', 18, 0, 0, 0, '', '', '', 'no', 0),
(83, 39, 'qNJy3ujfiAeBLTQFS28Q3eqQM', 'Consectetur adipiscing', 'consectetur-adipiscing', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.', 'Wed-Aug-18-2021-940-AM72792.jpg', 'Wed-Aug-18-2021-940-AM72792.jpg', 'Thu-Jul-8-2021-1014-AM24755.zip', 'file', NULL, '18', 10, 'subcategory', 'subcategory_18', 'plugins', '3', 18, 58, 'ee', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', '', '', '', 'magento,magento plugin', 0, 79, 0, 'yes', 6, 0, 0, '2022-02-09 11:13:33', '2022-02-09 11:13:33', 0, 0, 1, 0, '', '', '', 'no', 0),
(84, 39, 'O46UFkMbSeDuzZdOstVr5PvZo', 'Incididunt ut labore', 'incididunt-ut-labore', '&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;\r\n&lt;p&gt;Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum&lt;/p&gt;', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.', 'Wed-Aug-18-2021-940-AM83734.jpg', 'Wed-Aug-18-2021-940-AM83734.jpg', 'wed-nov-10-2021-12-15-pm99998.zip', 'file', NULL, '2', 8, 'subcategory', 'subcategory_2', 'themes', '2', 10, 150, '', 1, 5, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://test.com', 'mp3', '1611917126128.mp4', 'https://www.youtube.com/watch?v=HmZKgaHa3Fg', 'joomla themes,themes,sample', 0, 149, 0, 'yes', 3, 0, 1, '2022-02-09 11:13:16', '2022-02-09 11:13:16', 49, 0, 0, 0, '', '', 'tue-nov-9-2021-12-49-pm46394.mp3', 'no', 0),
(85, 43, '4DUi7Mvrts6nSYfG2r4DxnADW', 'WordPress Development', 'wordpress-development', '&lt;p&gt;WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development&amp;nbsp;&lt;/p&gt;', 'WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development WordPress Development', 'wed-feb-9-2022-10-23-am30806.png', 'wed-feb-9-2022-10-19-am17457.jpg', 'wed-feb-9-2022-10-24-am52232.zip', 'file', NULL, '7', 9, 'subcategory', 'subcategory_7', 'Scripts', '1', 1000, 6000, 'No Refund', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://wordpress.net', '', '', '', 'wordpress theme, php, website', 1, 43, 0, 'yes', 1, 1, 1, '2022-02-28 07:06:27', '2022-02-09 10:29:40', 0, 1, 1, 1, 'wordpress theme, php, website', 'wordpress theme, php, website', '', 'no', 1),
(86, 43, 'szkU2xnwirkOvjlKYZtmDBHLy', 'Food Delivery System PHP Laravel', 'food-delivery-system-php-laravel', '&lt;p&gt;Food Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP Laravel&lt;/p&gt;', 'Food Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP LaravelFood Delivery System PHP Laravel', 'wed-feb-9-2022-11-17-am42222.jpg', 'wed-feb-9-2022-11-17-am11466.jpg', 'wed-feb-9-2022-11-18-am27058.zip', 'file', NULL, '8', 8, 'category', 'category_8', 'Scripts', '1', 5000, 10000, 'No Refund', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://thefooddelivery.xyz', '', '', '', 'Food Devlivery System', 0, 58, 0, 'yes', 1, 1, 1, '2022-02-28 05:46:52', '2022-02-19 06:56:25', 0, 1, 1, 1, 'Food Devlivery System', 'Food Devlivery System', '', 'no', 1),
(87, 48, 'UnxSQfnCZCNvsN7jYyMhEZK2t', 'Superman Landing Nice Animation Video', 'superman-landing-nice-animation-video', '&lt;p&gt;Superman Landing Nice Animation Video&lt;/p&gt;', 'Superman Landing Nice Animation Video', 'wed-feb-9-2022-1-33-pm49210.jpg', 'wed-feb-9-2022-1-14-pm99722.jpg', 'wed-feb-9-2022-1-20-pm30932.zip', 'file', NULL, '52', 12, 'subcategory', 'subcategory_52', 'graphics', '5', 30, 0, '', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '', 'mp4', 'wed-feb-9-2022-1-39-pm24593.mp4', '', '', 0, 60, 0, 'yes', 0, 0, 1, '2022-02-27 18:04:16', '2022-02-19 06:57:40', 0, 1, 1, 1, 'superman\r\nlanding\r\nAnimation\r\nvideo\r\n3d\r\nobject\r\nmotion\r\ngraphics\r\nmoving\r\n2d\r\ncartoon\r\ndoodle\r\neffects\r\nelements\r\nTV\r\nCinema', 'superman\r\nlanding\r\nAnimation\r\nvideo\r\n3d\r\nobject\r\nmotion\r\ngraphics\r\nmoving\r\n2d\r\ncartoon\r\ndoodle\r\neffects\r\nelements\r\nTV\r\nCinema', '', 'no', 1),
(88, 43, 'wDQiHQ7W51GiRx0YoZU9e54fE', 'Student Management System Laravel', 'student-management-system-laravel', '&lt;p&gt;Student Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System Laravel&lt;/p&gt;', 'Student Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System LaravelStudent Management System Laravel', 'sat-feb-19-2022-6-47-am93751.png', 'sat-feb-19-2022-6-47-am83285.jpg', 'sat-feb-19-2022-6-48-am42584.zip', 'file', NULL, '2', 8, 'subcategory', 'subcategory_2', 'Scripts', '1', 2, 10000, 'No Refund', 0, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'https://doptor.org', '', '', '', 'test test', 0, 40, 0, 'yes', 0, 1, 1, '2022-02-27 17:34:05', '2022-02-19 06:55:28', 0, 1, 1, 1, 'Student Management System Laravel', 'Student Management System Laravel', '', 'no', 1);
...
CREATE TABLE `item_comments` (
  ...
  `comm_item_user_id` int(200) NOT NULL,
  `comm_item_id` int(200) NOT NULL,
...
CREATE TABLE `item_refund` (
  ...
  `ref_item_user_id` int(200) NOT NULL,
...
CREATE TABLE `item_type` (
  ...
  `item_type_status` int(50) NOT NULL DEFAULT '0',
...
CREATE TABLE `pages` (
  ...
  `page_allow_seo` int(50) NOT NULL,
...
CREATE TABLE `post` (
  ...
  `post_tags` text,
  `post_allow_seo` int(50) NOT NULL,
...
CREATE TABLE `settings` (
  ...
  `site_menu_category` int(50) NOT NULL,
  `site_banner` varchar(200) NOT NULL,
  `site_banner_heading` varchar(1000) NOT NULL,
  `site_banner_subheading` varchar(1000) NOT NULL,
  `site_item_per_page` int(50) NOT NULL,
  `site_post_per_page` int(50) NOT NULL,
  `item_approval` int(50) NOT NULL,
  ...
  `site_newest_files` int(50) NOT NULL,
  `site_category_newest_files` int(50) NOT NULL,
  ...
  `site_max_image_size` int(200) NOT NULL DEFAULT '0',
  `site_max_file_size` int(200) NOT NULL DEFAULT '0',
  `site_referral_commission` float NOT NULL DEFAULT '0',
  `site_s3_storage` int(50) NOT NULL DEFAULT '0',
  ...
  `watermark_option` int(50) NOT NULL DEFAULT '0',
  `google_analytics` varchar(200) DEFAULT NULL,
  `multi_language` int(50) NOT NULL,
  ...
  `display_social_login` int(50) NOT NULL,
  ...
  `payment_verification` int(50) NOT NULL,
  `site_blog_display` int(50) NOT NULL,
  `home_blog_display` int(50) NOT NULL,
  ...
  `site_comment_per_page` int(50) NOT NULL,
  `site_review_per_page` int(50) NOT NULL,
  `site_loader_display` int(50) NOT NULL,
  ...
  `home_featured_items` int(50) NOT NULL,
  `home_flash_items` int(50) NOT NULL,
  `home_blog_post` int(50) NOT NULL,
  `home_popular_items` int(50) NOT NULL,
  `home_free_items` int(50) NOT NULL,
  `site_loader_image` varchar(100) DEFAULT NULL,
  `item_support_link` varchar(200) DEFAULT NULL,
  `site_newsletter_display` int(50) NOT NULL,
  `site_features_display` int(50) NOT NULL,
  `site_selling_display` int(50) NOT NULL,
...
INSERT INTO `subcategory` (`subcat_id`, `cat_id`, `subcategory_name`, `subcategory_slug`, `subcategory_order`, `subcategory_status`, `drop_status`) VALUES
(1, 8, 'JavaScript', 'JavaScript', 51, 1, 'no'),
(2, 8, 'PHP Scripts', 'PHP-Scripts', 50, 1, 'no'),
(3, 8, 'CSS', 'CSS', 49, 1, 'no'),
(4, 8, 'HTML5', 'HTML5', 48, 1, 'no'),
(5, 8, '.NET', '-NET', 47, 1, 'no'),
(6, 8, 'Skins', 'Skins', 46, 1, 'no'),
(7, 9, 'WordPress', 'WordPress', 45, 1, 'no'),
(8, 9, 'HTML/CSS', 'HTML-CSS', 44, 1, 'no'),
(9, 9, 'Bootstrap', 'Bootstrap', 43, 1, 'no'),
(10, 9, 'Muse', 'Muse', 42, 1, 'no'),
(11, 9, 'Joomla', 'Joomla', 41, 1, 'no'),
(12, 9, 'Magento', 'Magento', 40, 1, 'no'),
(13, 9, 'Drupal', 'Drupal', 39, 1, 'no'),
(14, 9, 'OpenCart', 'OpenCart', 38, 1, 'no'),
(15, 9, 'PrestaShop', 'PrestaShop', 37, 1, 'no'),
(16, 9, 'Tumblr', 'Tumblr', 36, 1, 'no'),
(17, 10, 'WordPress Plugins', 'WordPress-Plugins', 35, 1, 'no'),
(18, 10, 'Magento Extensions', 'Magento-Extensions', 34, 1, 'no'),
(19, 10, 'Joomla', 'Joomla', 33, 1, 'no'),
(20, 10, 'Drupal', 'Drupal', 32, 1, 'no'),
(21, 10, 'OpenCart', 'OpenCart', 31, 1, 'no'),
(22, 10, 'ExpressionEngine', 'ExpressionEngine', 30, 1, 'no'),
(23, 10, 'osCommerce', 'osCommerce', 29, 1, 'no'),
(24, 10, 'Prestashop', 'Prestashop', 28, 1, 'no'),
(25, 10, 'Concrete5', 'Concrete5', 27, 1, 'no'),
(26, 10, 'VirtueMart', 'VirtueMart', 26, 1, 'no'),
(27, 10, 'Zen Cart', 'Zen-Cart', 25, 1, 'no'),
(28, 10, 'Ubercart', 'Ubercart', 24, 1, 'no'),
(29, 11, 'Business Cards', 'Business-Cards', 23, 1, 'no'),
(30, 11, 'Brochures', 'Brochures', 22, 1, 'no'),
(31, 11, 'Flyers', 'Flyers', 21, 1, 'no'),
(32, 11, 'Resumes', 'Resumes', 20, 1, 'no'),
(33, 11, 'Logos', 'Logos', 19, 1, 'no'),
(34, 11, 'Magazines', 'Magazines', 18, 1, 'no'),
(35, 11, 'Stationery', 'Stationery', 17, 1, 'no'),
(36, 11, 'Newsletters', 'Newsletters', 16, 1, 'no'),
(37, 11, 'Cards & Invites', 'Cards-Invites', 15, 1, 'no'),
(38, 11, 'Other', 'Other', 14, 1, 'no'),
(39, 12, 'Icons', 'Icons', 13, 1, 'no'),
(40, 12, 'Illustrations', 'Illustrations', 12, 1, 'no'),
(41, 12, 'Objects', 'Objects', 11, 1, 'no'),
(42, 12, 'Patterns', 'Patterns', 10, 1, 'no'),
(43, 12, 'Product Mock-Ups', 'Product-Mock-Ups', 9, 1, 'no'),
(44, 12, 'Textures', 'Textures', 8, 1, 'no'),
(45, 12, 'Web Elements', 'Web-Elements', 7, 1, 'no'),
(46, 13, 'Android', 'Android', 6, 1, 'no'),
(47, 13, 'iOS', 'iOS', 5, 1, 'no'),
(48, 13, 'Native Web', 'Native-Web', 4, 1, 'no'),
(49, 13, 'Unity', 'Unity', 3, 1, 'no'),
(50, 13, 'Corona', 'Corona', 2, 1, 'no'),
(51, 13, 'Titanium', 'Titanium', 1, 1, 'no'),
(52, 12, 'Animation', 'animation', 0, 1, 'no'),
(53, 12, 'Motion Graphics', 'motion-graphics', 1, 1, 'no'),
(54, 14, 'Unity', 'unity', 0, 1, 'no');
...
CREATE TABLE `users` (
  ...
  `user_document_verified` int(50) NOT NULL,
  `user_permission` varchar(200) DEFAULT NULL,
  `user_subscr_id` int(100) NOT NULL,
  ...
  `user_subscr_item` int(100) NOT NULL,
  `user_subscr_download_item` mediumint(9) NOT NULL,
  `user_today_download_limit` mediumint(9) NOT NULL,
  `user_today_download_date` date NOT NULL,
  `user_subscr_space_level` varchar(50) DEFAULT NULL,
  `user_subscr_space` int(100) NOT NULL,
  ...
  `user_payhere_mode` int(50) NOT NULL,
  `user_payhere_merchant_id` varchar(200) DEFAULT NULL,
  `user_payumoney_mode` int(50) NOT NULL,
  ...
  `user_iyzico_mode` int(50) NOT NULL,
  `user_flutterwave_public_key` varchar(500) DEFAULT NULL,
  `user_flutterwave_secret_key` varchar(500) DEFAULT NULL,
  `user_coingate_mode` int(50) NOT NULL,
  `user_coingate_auth_token` varchar(500) DEFAULT NULL,
  `user_message_permission` int(50) NOT NULL DEFAULT '1',
  `item_update_email` int(20) NOT NULL DEFAULT '0',
  `item_comment_email` int(20) NOT NULL DEFAULT '0',
  `item_review_email` int(20) NOT NULL DEFAULT '0',
  `buyer_review_email` int(20) NOT NULL DEFAULT '0',
  `user_freelance` int(20) NOT NULL DEFAULT '0',
  `country_badge` int(50) NOT NULL DEFAULT '0',
  `exclusive_author` int(50) NOT NULL DEFAULT '0',
  `remember_token` varchar(100) DEFAULT NULL,
  `referral_by` int(50) DEFAULT NULL,
  ...
  `drop_status` varchar(50) NOT NULL DEFAULT 'no',
  `user_ipay_mode` int(11) NOT NULL,
...
(1, NULL, NULL, 'admin', 'admin', 'admin@doptorr.com', NULL, 'admin', '1607941980.png', '1561461056456.jpg', 'wY8wGc5rFLhA57SpAzw7ZP37m', '$2y$10$ZT9sgt..ibOFspa7c8RhHuEh98m4ecVDr10JL7KT0tjS/R0sF6dHq', NULL, 1146.2, 'http://google.com', '17', 'Hello welcome', 'i am a web designer.', 'http://facebook.com', 'http://twitter.com', 'http://google.com', NULL, NULL, NULL, 1, 0, 'dashboard,settings,items,refund,rating,withdrawal,blog,pages,features,subscription,selling,contact,newsletter,languages', 0, NULL, 0, '0000-00-00', NULL, 0, 0, 0, '2022-02-28', NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, 1, 1, 1, 1, 1, 0, 0, 0, NULL, NULL, NULL, 0, 0, '2019-06-17 05:25:51', '2022-02-28 07:26:06', 'no', 0, NULL, NULL, NULL),
...
(39, NULL, NULL, 'vendor', 'vendor', 'vendor@gmail.com', NULL, 'vendor', '1607946988.png', '', 'wpCGMiF6cqKY5FaT2miS6FZHc', '$2y$10$IyxCTVDH4pYRfTIzgY8mf.sjsKBmcaOtWf9fdKNyAiWS5gI9HlBgO', 'MTIzNDU2', 212.6, '', '12', 'Web Development Services', 'Lorem ipsum lorem ipsum...', 'https://www.facebook.com', 'https://www.twitter.com', '', 'https://www.instagram.com', 'https://www.linkedin.com', 'https://www.pinterest.com', 1, 1, NULL, 1, 'Deluxe', 150, '2022-02-10', 'limited', 50, 100, 3, '2022-01-21', 'limited', 10, 'GB', '', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, 1, 1, 1, 1, 1, 0, 1, 1, NULL, NULL, NULL, 570, 2, '2019-08-29 06:26:28', '2022-01-21 04:13:40', 'no', 0, NULL, NULL, NULL),
...
(43, NULL, NULL, 'Rafid Ryan', 'rafid', 'rafidryan@gmail.com', NULL, 'vendor', '', '', 'K56qs2gE2tqbqbgLaA9ZQNoXf', '$2y$10$Bij8OMvXADDO2afssdgW2.4O34oYLbq9qvqVnWxhkv0nFW2tIUdPC', 'cmFuYS5iZDEyMw==', 3750, '', '20', 'Web Development Services, Mobile Apps Development.', 'Web Development Services, Mobile Apps Development.', '', '', '', '', '', '', 1, 0, NULL, 0, NULL, 0, '0000-00-00', NULL, 0, 1000, 0, '2022-02-26', NULL, 0, NULL, NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, NULL, NULL, 0, NULL, 1, 1, 1, 1, 1, 1, 1, 1, NULL, 0, '', 0, 0, '2022-02-07 14:00:06', '2022-02-22 08:18:01', 'no', 0, NULL, NULL, 'https://doptorr.com/user-verify/K56qs2gE2tqbqbgLaA9ZQNoXf'),
...
--
ALTER TABLE `attributes`
  MODIFY `attr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
...
--
ALTER TABLE `conversation`
  MODIFY `conver_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;
...
--
ALTER TABLE `email_template`
  MODIFY `et_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=21;
...
--
ALTER TABLE `items_attributes`
  MODIFY `item_attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1277;

--
-- AUTO_INCREMENT for table `items_data`
--
ALTER TABLE `items_data`
  MODIFY `itm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT for table `items_favorite`
--
ALTER TABLE `items_favorite`
  MODIFY `fav_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `items_images`
--
ALTER TABLE `items_images`
  MODIFY `itm_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=147;

--
-- AUTO_INCREMENT for table `item_checkout`
--
ALTER TABLE `item_checkout`
  MODIFY `chout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=445;
...
--
ALTER TABLE `item_comment_reply`
  MODIFY `comm_reply_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT for table `item_order`
--
ALTER TABLE `item_order`
  MODIFY `ord_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=164;
...
--
ALTER TABLE `item_refund`
  MODIFY `refund_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=26;
...
--
ALTER TABLE `item_withdrawal`
  MODIFY `wd_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `subcategory`
  MODIFY `subcat_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;

--
-- AUTO_INCREMENT for table `subscription`
--
ALTER TABLE `subscription`
  MODIFY `subscr_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
