...
class Languages extends Model
{
  ...
  public static function en_Translate_check($id,$code)
  {

    $get=DB::table('keywords')->where('keyword_id', '=', $id)->where('language_code', '=', $code)->get(); 
    $value = $get->count(); 
    return $value;
	
  }	
  
  public static function other_Translate_check($id,$code)
  {

    $get=DB::table('keywords')->where('keyword_parent', '=', $id)->where('language_code', '=', $code)->get(); 
    $value = $get->count(); 
    return $value;
  ...
  public static function LastidGet($token_key)
  {
     $id = DB::table('keywords')->where('keyword_id', '=', $token_key)->first();
	 return $id;
  }
