...
class SettingsController extends Controller
{
	 ...
	 public function update_general_settings(Request $request)
	{
		 ...
		 $service_banner_heading = $request->input('service_banner_heading');
		 $service_banner_subheading = $request->input('service_banner_subheading');
  ...
  public function email_settings()
	...
	public function update_preferred_settings(Request $request)
	{
        ...
        Settings::updategeneralData($sid, $data);
		$addition_data = array('subscription_mode' => $subscription_mode, 'refund_mode' => $refund_mode, 'verify_mode' => $verify_mode);
		Settings::updateAdditionData($addition_data);
        return redirect()->back()->with('success', 'Update successfully.');
	...
	public function payment_settings()
    {
		...
		$payment_option = array('paypal','wallet','2checkout','paystack','localbank','razorpay','payhere','payumoney', 'iyzico','flutterwave', 'coingate','ipay','stripe', 'shurjopay');
		$withdraw_option = array('paypal','stripe','paystack','localbank');
		$vendor_payment_option = array('paypal','2checkout','razorpay','payhere','payumoney', 'iyzico','flutterwave', 'coingate','ipay','stripe');
