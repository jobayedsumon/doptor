      ...
      <div class="container pt-2 pb-3">
        <div class="row">
          <div class="col-md-4 text-center text-md-left mb-4">
            ...
            <img class="d-block" width="150" src="{{ url('/') }}/public/storage/settings/{{ $additional->site_footer_logo }}" alt="{{ $allsettings->site_title }}"/>
            @endif
            </a>
            </div>
            ...
            <h6 class="mr-3"><span class="text-primary">{{ $total_files }} </span><span class="font-weight-normal text-white">{{ Helper::translation(3003,$translate,'') }}</span></h6>
            <h6 class="mr-3"><span class="text-primary">{{ $total_services }} </span><span class="font-weight-normal text-white">Services</span></h6>
            <h6 class="mr-3"><span class="text-primary">{{ $service_orders }} </span><span class="font-weight-normal text-white">Orders</span></h6>
          ...
          <div class="col-md-2 d-none d-md-block text-center text-md-left mb-4">
            <div class="widget widget-links widget-light pb-2">
              ...
              <ul class="widget-list">
                ...
                <li class="widget-list-item"><a class="widget-list-link" href="{{ URL::to('/service/category/') }}/{{$maincategory->category_slug}}">{{ $maincategory->category_name }}</a></li>
                @endforeach
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-4">
            ...
            <img src="{{ asset('public/img/Payment_gateway_Logo.png') }}" width="400px"/>
          </div>
          @endif
        </div>
      </div>
      <div class="pt-4 bg-darker">
        <div class="container">
          <div class="d-md-flex justify-content-between row">
            <div class="col-md-6 pb-4 font-size-xs text-light opacity-50 text-center text-md-left">&copy; {{ date('Y') }}  {{ $allsettings->site_title }}</div>
