          ...
          <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
            ...
            <div class="row">
             <div class="col-sm-12 mb-1">
              ...
              <div class="col-sm-12 mb-1">
              <div class="alert alert-info alert-with-icon font-size-sm mb-4" role="alert">
                <div class="alert-icon-box"><i class="alert-icon dwg-announcement"></i></div><b>{{ Helper::translation(2983,$translate,'') }} :</b> jpeg, jpg<br/><b>{{ Helper::translation(2985,$translate,'') }} :</b> {{ Helper::translation(5964,$translate,'') }}
