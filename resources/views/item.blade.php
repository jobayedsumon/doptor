...
@endif
@include('style')
<meta property="og:image" content="{{ url('/') }}/public/storage/items/{{ $item['item']->item_thumbnail }}"/>
<meta name="twitter:card" content="summary_large_image" />
<meta name="twitter:image" content="{{ url('/') }}/public/storage/items/{{ $item['item']->item_thumbnail }}"/>
<meta name="twitter:image:src" content="{{ url('/') }}/public/storage/items/{{ $item['item']->item_thumbnail }}">
          ...
          <section class="col-lg-8 pt-2 pt-lg-4 pb-4 mb-lg-3">
            <div class="pt-2 px-4 pr-lg-0 pl-xl-5">
              ...
              <div class="cz-gallery">
                      ...
                      <video width="100%" height="auto" src="{{ $videofileurl }}" controls>{{ Helper::translation(5979,$translate,'') }}</video>
                      @else
                      <video width="100%" height="auto" src="{{ url('/') }}/public/storage/items/{{ $item['item']->video_file }}" controls>{{ Helper::translation(5979,$translate,'') }}</video>
                      @endif
                      @else
                      <img src="{{ url('/') }}/resources/views/assets/no-video.png" alt="{{ $item['item']->item_name }}" class="single-thumbnail">
                      @endif
                      ...
                      @if($allsettings->site_s3_storage == 1)
                      @php $audiofileurl = Storage::disk('s3')->url($item['item']->audio_file); @endphp
                      <audio controls="controls"><source src="{{ $audiofileurl }}" type="audio/mpeg" /></audio>
                      @else
                      <audio controls="controls"><source src="{{ url('/') }}/public/storage/items/{{ $item['item']->audio_file }}" type="audio/mpeg" /></audio>
                      @endif
                      @else
                      <img src="{{ url('/') }}/resources/views/assets/no-audio.png" alt="{{ $item['item']->item_name }}" class="single-thumbnail">
                      @endif
                      @endif
                      @else  
              ...
              <div class="d-flex flex-wrap justify-content-between align-items-center border-top pt-3">
                ...
                <a class="social-btn sb-outline sb-pinterest sb-sm ml-2 share-button" data-share-url="{{ URL::to('/item') }}/{{ $item['item']->item_slug }}" data-share-network="pinterest" data-share-text="{{ $item['item']->item_shortdesc }}" data-share-title="{{ $item['item']->item_name }}" data-share-via="{{ $allsettings->site_title }}" data-share-tags="" data-share-media="{{ url('/') }}/public/storage/items/{{ $item['item']->item_thumbnail }}" href="javascript:void(0)"><i class="dwg-pinterest"></i></a>
          ...
          <aside class="col-lg-4">
            ...
            <div class="cz-sidebar-static h-100 ml-auto border-left">
                  ...
                  <div class="collapse show" id="standard-license" data-parent="#licenses">
                    <div class="card-body py-0 pb-2">
                      <ul class="list-unstyled font-size-sm">
                        ...
                        <li class="d-flex align-items-center"><i class="dwg-check-circle text-success mr-1"></i><span class="font-size-ms">{{ $additional->regular_license }} {{ Helper::translation(6255,$translate,'') }} {{ $item['item']->username }}</span></li>
                        @else
                        <li class="d-flex align-items-center"><i class="dwg-close-circle text-danger mr-1"></i><span class="font-size-ms">{{ $additional->regular_license }} {{ Helper::translation(6258,$translate,'') }} {{ $item['item']->username }}</span></li>
                        @endif
                      </ul>
                    </div>
                  </div>
                  ...
                  <div class="collapse" id="extended-license" data-parent="#licenses">
                    <div class="card-body py-0 pb-2">
                      <ul class="list-unstyled font-size-sm">
                        ...
                        @endif
                        @if($item['item']->item_support == 1)
                        <li class="d-flex align-items-center"><i class="dwg-check-circle text-success mr-1"></i><span class="font-size-ms">{{ $additional->extended_license }} {{ Helper::translation(6255,$translate,'') }} {{ $item['item']->username }}</span></li>
                        @else
                        <li class="d-flex align-items-center"><i class="dwg-close-circle text-danger mr-1"></i><span class="font-size-ms">{{ $additional->extended_license }} {{ Helper::translation(6258,$translate,'') }} {{ $item['item']->username }}</span></li>
                        @endif
                      </ul>
                    </div>
                  </div>
              ...
              @endif
                ...
                @endif
                <small>By clicking the "Buy Bow" button you agree to our Terms and Conditions and acknowledge that your information will be handled as detailed in our Privacy Policy & Refund Policy. You acknowledge that in order to continue the process our representative will contact you.</small>
                @if($item['item']->free_download == 1)
                @else
                @if(Auth::guest())
                ...
                @endif
                @else
                <a class="btn btn-primary btn-shadow btn-block mt-4" href="{{ URL::to('/purchases') }}"><i class="dwg-cart font-size-lg mr-2"></i>{{ Helper::translation(6264,$translate,'') }}</a> 
                @endif    
                @endif
                @endif 
                @endif
          ...
          <div class="card product-card-alt">
            ...
            <div class="card-body">
              ...
              <a class="blog-entry-meta-link" href="{{ URL::to('/user') }}/{{ $featured->username }}">
				    ...
				    {{ $featured->username }}	  
				    @endif 
					@if($addition_settings->subscription_mode == 1) @if($featured->user_document_verified == 1) <span class="badges-success"><i class="dwg-check-circle danger"></i> {{ Helper::translation(5202,$translate,'') }}</span>@endif @endif</a>
