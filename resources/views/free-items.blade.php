...
<html lang="en">
<head>
<title>{{ $allsettings->site_title }} - {{ Helper::translation(3016,$translate,'') }}</title>
@include('meta')
@include('style')
</head>
<body>
        ...
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-star">
              ...
              <li class="breadcrumb-item text-nowrap active" aria-current="page">{{ Helper::translation(3016,$translate,'') }}</li>
            </ol>
          </nav>
        </div>
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0 text-white">{{ Helper::translation(3016,$translate,'') }}</h1>
        </div>
      </div>
      </div>
    </section>
