            ...
            <div class="col-sm-4">
                <div class="page-header float-left">
                    <div class="page-title">
                        <h1>{{ Helper::translation(2934,$translate,'Edit Coupon') }}</h1>
                    </div>
                </div>
            </div>
            <div class="col-sm-8">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="coupon_status" class="form-control" data-bvalidator="required">
                                                 <option value=""></option>
                                                 <option value="1" @if($edit['value']->coupon_status == 1) selected @endif>{{ Helper::translation(2874,$translate,'Active') }}</option>
                                                 <option value="0" @if($edit['value']->coupon_status == 0) selected @endif>{{ Helper::translation(2875,$translate,'InActive') }}</option>
                                                 </select>
                                            </div>
                                     </div>
                                </div>
                                ...
                                <div id="pay-invoice">
                                    ...
                                    <div class="form-group">
                                                ...
                                                <select name="discount_type" class="form-control" data-bvalidator="required">
                                                 <option value=""></option>
                                                 <option value="percentage" @if($edit['value']->discount_type == 'percentage') selected @endif>{{ Helper::translation(2871,$translate,'Percentage') }}</option>
                                                 <option value="fixed" @if($edit['value']->discount_type == 'fixed') selected @endif>{{ Helper::translation(2872,$translate,'Fixed') }}</option>
                                                 </select>
                                            </div>
                                    <div class="form-group">
