                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <textarea name="site_tawk_chat" id="site_tawk_chat" rows="6" class="form-control noscroll_textarea" required>{{ $additional->site_tawk_chat}}</textarea> <small><strong>Example:</strong> <br/><img src="{{ url('/') }}/resources/views/theme/img/tawk.png" /></small>
                                            </div>  
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="service_banner_heading" class="control-label mb-1">Service Banner Heading <span class="require">*</span></label>
                                                <input id="service_banner_heading" name="service_banner_heading" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->service_banner_heading }}" required>
                                            </div>  
                                            
                              <div class="form-group">
                                                <label for="service_banner_subheading" class="control-label mb-1">Service Banner Subheading <span class="require">*</span></label>
                                                <input id="service_banner_subheading" name="service_banner_subheading" type="text" class="form-control noscroll_textarea" value="{{ $setting['setting']->service_banner_subheading }}" required>
                                            </div>   
                             ...
                             <div class="form-group">
                                            ...
                                            @if($additional->site_footer_logo != '')
                                                <img height="24" src="{{ url('/') }}/public/storage/settings/{{ $additional->site_footer_logo }}" />
                                                @endif
                                            </div>
