                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(6408,$translate,'') }} {{ Helper::translation(5721,$translate,'') }} ({{ $setting['setting']->site_currency }})<span class="require">*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="site_title" class="control-label mb-1">{{ Helper::translation(6411,$translate,'') }} ({{ $setting['setting']->site_currency }})<span class="require">*</span></label>
