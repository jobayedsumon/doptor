                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="subcategory_type" class="control-label mb-1"> Type <span class="require">*</span></label>
                                            <select name="subcategory_type" class="form-control" required>
                                                <option value=""></option>
                                                <option value="item" @if($edit['subcategory']->subcategory_type == 'item') selected="selected" @endif>Item</option>
                                                <option value="service" @if($edit['subcategory']->subcategory_type == 'service') selected="selected" @endif>Service</option>
                                            </select>
                                        </div>
