                            ...
                            <div class="card-body">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label for="category_type" class="control-label mb-1"> Type <span class="require">*</span></label>
                                            <select name="category_type" class="form-control" required>
                                                <option value=""></option>
                                                <option value="item" @if($edit['category']->category_type == 'item') selected="selected" @endif>Item</option>
                                                <option value="service" @if($edit['category']->category_type == 'service') selected="selected" @endif>Service</option>
                                            </select>
                                        </div>
