<header class="bg-light box-shadow-sm navbar-sticky">
    ...
    <div class="topbar topbar-dark bg-dark">
      <div class="container">
        ...
        @if(Auth::guest())
        <a class="topbar-link ml-3 pl-3 border-left border-light d-none d-md-inline-block" href="{{ URL::to('/start-selling') }}"><i class="dwg-cart mt-n1"></i>{{ Helper::translation(3018,$translate,'') }}</a>
        @else
        @if(Auth::user()->user_type == 'vendor')
        <a class="topbar-link ml-3 pl-3 border-left border-light d-none d-md-inline-block" href="{{ URL::to('/manage-item') }}"><i class="dwg-cart mt-n1"></i>{{ Helper::translation(3018,$translate,'') }}</a>
        @endif
        @endif
        @endif
    ...
    <div class="navbar-sticky">
      <div class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand d-sm-none mr-2 order-lg-1" href="{{ URL::to('/') }}" style="min-width: 4.625rem;">
           <img width="90" src="{{ url('/') }}/public/storage/settings/{{ $allsettings->site_logo }}" alt="{{ $allsettings->site_title }}"/>
        </a>
        @endif
          <div class="navbar-toolbar d-flex align-items-center order-lg-3">
            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarCollapse"><span class="navbar-toggler-icon"></span></button><a class="navbar-tool d-none d-lg-flex" href="#searchBox" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="searchBox"><span class="navbar-tool-tooltip">{{ Helper::translation(4857,$translate,'') }}</span>
              ...
              <a class="navbar-tool-icon-box border dropdown-toggle" data-toggle="dropdown" @if(Auth::user()->id == 1) href="{{ url('/admin') }}" target="_blank" @else href="{{ URL::to('/user') }}/{{ Auth::user()->username }}" @endif>         @if(!empty(Auth::user()->user_photo))
                ...
                <div class="widget widget-cart px-3 pt-2 pb-3">
                  <div data-simplebar data-simplebar-auto-hide="false">
                    ...
                    <div class="widget-cart-item pb-2 mb-2 border-bottom">
                      ...
                      @if($msg->user_photo!='')
                      <img width="40" src="{{ url('/') }}/public/storage/users/{{ $msg->user_photo }}" alt="{{ $msg->username }}" class="rounded-circle"/>
                      @else
                      <img width="40" src="{{ url('/') }}/public/img/no-image.png" alt="{{ $msg->username }}" class="rounded-circle"/>
                      @endif
                      </a>
          ...
          <div class="collapse navbar-collapse mr-auto order-lg-2" id="navbarCollapse">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item dropdown"><a class="nav-link" href="{{ url('/subscription') }}">{{ Helper::translation(6105,$translate,'') }}</a></li>
              @endif
      ...
      <div class="navbar-collapse collapse" id="main-nav-1">
        <ul class="navbar-nav flex-wrap">
          @forelse($categories as $category)
            <li class="nav-item dropdown position-static m-2"><a href="#" class="nav-link dropdown-toggle py-0 text-dark" data-toggle="dropdown" data-target="#">{{ $category->category_name }}</a>
                  ...
                  <div class="row w-100 pt-3">
                    <div class="col-6">
                      <div class="row">
                        ...
                        <div class="col-6">
                          <a href="#" class="nav-link dropdown-toggle py-0 text-dark m-2" data-toggle="dropdown" data-target="#">{{ $subcategory->subcategory_name }}</a>
                        </div>
