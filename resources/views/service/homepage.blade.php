...
<body>
@include('service.service-header')
<section class="bg-position-center-top" style="background-image: url('{{ url('/') }}/public/storage/settings/{{ $allsettings->site_banner }}');">
      <div class="mb-lg-3 pb-4 pt-5">
        <div class="container">
          <div class="row mb-4 mb-sm-5">
            <div class="col-lg-7 col-md-9 text-center mx-auto">
              <h1 class="text-white line-height-base">{{ $allsettings->service_banner_heading }}</h1>
              <h2 class="h4 text-white font-weight-light">{{ $allsettings->service_banner_subheading }}</h2>
            </div>
          </div>
...
<section class="container mb-lg-1" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        ...
        <div class="pt-3" data-aos="fade-down" data-aos-delay="100">
          <a class="btn btn-outline-accent" href="{{ URL::to('/') }}/featured-services">Browse All Services<i class="dwg-arrow-right font-size-ms ml-1"></i></a>
        </div>
      </div>
      <!-- Grid-->
...
<section class="container mb-lg-1 flash-sale" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        ...
        <div class="pt-3" data-aos="fade-down" data-aos-delay="100">
          <a class="btn btn-outline-accent" href="{{ URL::to('/') }}/popular-services">Browse All Services<i class="dwg-arrow-right font-size-ms ml-1"></i></a>
        </div>
      </div>
      <!-- Grid-->
...
{{--    </section>--}}
    ...
    <section class="container pb-4 pb-md-5" data-aos="fade-up" data-aos-delay="200">
      <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        ...
        <div class="pt-3" data-aos="fade-down" data-aos-delay="100">
          <a class="btn btn-outline-accent" href="{{ URL::to('/new-services') }}">Browse All Services<i class="dwg-arrow-right font-size-ms ml-1"></i></a>
        </div>
      </div>
      <div class="row">
        <!-- Bestsellers-->
           ...
           <div class="widget">    
            ...
            @endif
              ...
              <div class="media-body">
                ...
                @if($featured->free_download == 0)
                <span class="text-accent">{{ $allsettings->site_currency_symbol }}{{ $price }}</span> @if($featured->item_flash == 1)<del class="price-old">{{ $allsettings->site_currency_symbol }}{{ $featured->regular_price }}</del>@endif
                @else
                <span class="text-accent">{{ Helper::translation(2992,$translate,'') }}</span>
                @endif
                </div>
              </div>
            </div>
