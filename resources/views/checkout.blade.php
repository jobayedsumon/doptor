              ...
              <div class="accordion mb-2" id="payment-method" role="tablist">
                ...
                <div class="card">
                  ...
                  @if($payment == 'stripe')
                    ...
                    @endif
                    @if($payment == 'shurjopay')
                        
                    
                       <div class="card-body font-size-sm custom-control custom-radio">
                      <p><span class='font-weight-medium'><input id="opt1-shurjopay" name="payment_method" type="radio" class="custom_radio" value="shurjopay" @if($no == 1) checked @endif data-bvalidator="required">ShurjoPay</span> - Pay with Shurjopay</p>
                      <button class="btn btn-primary" type="submit">ShurjoPay</button>
                    </div>
            ...
            <div class="cz-sidebar-static h-100 ml-auto border-left">
              <div class="widget mb-3">
                ...
                @if($allsettings->site_extra_fee != 0)
                  ...
                  @endphp
                  @endif 
                  <h3 class="font-weight-normal text-center my-4">{{ $allsettings->site_currency_symbol }} {{ $final + $vat_price }}</h3>
                  <h6 class="font-weight-normal text-center my-4">(BDT {{ ($final + $vat_price) * 86.10 }})</h6>
                  </ul>
               </div>
            </div>
          </aside>
