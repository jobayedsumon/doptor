...
<div class="container py-5 mt-md-2 mb-2">
      <div class="row">
        <div class="col-lg-12" data-aos="fade-up" data-aos-delay="200" align="center">
          <h4>{{ Helper::translation('61e6743e84157',$translate,'Your subscription has been expired. Please renewal your') }} <a href="{{ URL::to('/subscription') }}">{{ Helper::translation(6105,$translate,'') }}</a></h4><br/>
         </div>
      </div>
    </div>