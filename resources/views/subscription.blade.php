...
<html lang="en">
<head>
<title>{{ $allsettings->site_title }} - {{ Helper::translation(6105,$translate,'') }}</title>
@include('meta')
@include('style')
</head>
<body>
 						...
 						<div class="price-list">
 							<ul>
                                @if($subscription->subscr_item_level == 'limited')
 								<li><i class="fa fa-check" aria-hidden="true"></i> {{ $subscription->subscr_item }} {{ Helper::translation(6425,$translate,'Upload') }} {{ Helper::translation(5442,$translate,'') }}</li>
                                @else
                                <li><i class="fa fa-check" aria-hidden="true"></i> {{ Helper::translation(6437,$translate,'Unlimited Upload Items') }}</li>
                                @endif
                                @if($subscription->subscr_download_item != 0)
                                <li><i class="fa fa-check" aria-hidden="true"></i> {{ $subscription->subscr_download_item }} {{ Helper::translation(6431,$translate,'Download items per day') }}</li>
                                @endif
