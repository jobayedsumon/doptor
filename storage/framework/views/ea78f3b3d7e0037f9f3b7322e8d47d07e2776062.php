...
<div class="container pb-5 mb-2 mb-md-3">
      <div class="row">
        ...
        <section class="col-lg-8">
          ...
          <div class="row mx-n2 pt-2">
                ...
                <div class="col-md-4 col-sm-12 px-2 mb-4">
                  <div class="bg-secondary h-100 rounded-lg p-4 text-center">
                    <h3 class="font-size-sm text-muted"><?php echo e(Helper::translation(6431,$translate,'Download items per day')); ?></h3>
                    <p class="h3 mb-2"><?php echo e(Auth::user()->user_subscr_download_item); ?></p>
                  </div>
                </div>
                <div class="col-md-4 col-sm-12 px-2 mb-4">
                  <div class="bg-secondary h-100 rounded-lg p-4 text-center">
                    <h3 class="font-size-sm text-muted"><?php echo e(Helper::translation(6434,$translate,'Today download items limit')); ?></h3>
            ...
            <div class="row">
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  ...
                  <span class="become_vendor"><small><?php echo e(Helper::translation(6336,$translate,'')); ?></small></span>
                </div>
              </div>
              <?php if($addition_settings->subscription_mode == 1): ?>
              <?php if($count_mode == 1): ?>
    ...
    </div><?php /**PATH /var/www/html/doptor/resources/views/profile.blade.php ENDPATH**/ ?>