...
<body>
<?php echo $__env->make('service.service-header', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        ...
        <div class="container">
          <div class="row mb-4 mb-sm-5">
            <div class="col-lg-7 col-md-9 text-center mx-auto">
              <h1 class="text-white line-height-base"><?php echo e($allsettings->service_banner_heading); ?></h1>
              <h2 class="h4 text-white font-weight-light"><?php echo e($allsettings->service_banner_subheading); ?></h2>
            </div>
          </div>
          ...
          <div class="row mb-4 mb-sm-5">
            <div class="col-lg-6 col-md-8 mx-auto text-center">
              <div class="input-group input-group-overlay input-group-lg">
                ...
                <input class="form-control form-control-lg prepended-form-control rounded-right-0" type="text" id="product_item" name="product_item" placeholder="Search your services..."><div class="input-group-append">
...
<section class="container mb-lg-1" data-aos="fade-up" data-aos-delay="200">
      ...
      <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        <h2 class="h3 mb-0 pt-3 mr-2" data-aos="fade-down" data-aos-delay="100">Featured Services</h2>
        <div class="pt-3" data-aos="fade-down" data-aos-delay="100">
          <a class="btn btn-outline-accent" href="<?php echo e(URL::to('/')); ?>/featured-services">Browse All Services<i class="dwg-arrow-right font-size-ms ml-1"></i></a>
        </div>
      </div>
      <!-- Grid-->
          ...
          <div class="card product-card-alt">
            ...
            <div class="card-body">
              ...
              <a class="blog-entry-meta-link" href="<?php echo e(URL::to('/user')); ?>/<?php echo e($featured->username); ?>">
					...
					<?php if($addition_settings->subscription_mode == 1): ?> <?php if($featured->user_document_verified == 1): ?> <span class="badges-success"><i class="dwg-check-circle danger"></i> <?php echo e(Helper::translation(5202,$translate,'')); ?></span><?php endif; ?> <?php endif; ?></a>
...
<section class="container mb-lg-1 flash-sale" data-aos="fade-up" data-aos-delay="200">
      <!-- Heading-->
      <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        <h2 class="h3 mb-0 pt-3 mr-2" data-aos="fade-down" data-aos-delay="100">Popular Services</h2>
        <div class="pt-3" data-aos="fade-down" data-aos-delay="100">
          <a class="btn btn-outline-accent" href="<?php echo e(URL::to('/')); ?>/popular-services">Browse All Services<i class="dwg-arrow-right font-size-ms ml-1"></i></a>
        </div>
      </div>
      <!-- Grid-->
    ...
    <section class="container pb-4 pb-md-5" data-aos="fade-up" data-aos-delay="200">
      <div class="d-flex flex-wrap justify-content-between align-items-center pt-1 border-bottom pb-4 mb-4">
        <h2 class="h3 mb-0 pt-3 mr-2" data-aos="fade-down" data-aos-delay="100">New Services</h2>
        <div class="pt-3" data-aos="fade-down" data-aos-delay="100">
          <a class="btn btn-outline-accent" href="<?php echo e(URL::to('/new-services')); ?>">Browse All Services<i class="dwg-arrow-right font-size-ms ml-1"></i></a>
        </div>
      </div>
      <div class="row">
        <!-- Bestsellers-->
           ...
           <div class="widget">    
            ...
            <?php endif; ?>
              ...
              <div class="media-body">
                ...
                <?php if($featured->free_download == 0): ?>
                <span class="text-accent"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($price); ?></span> <?php if($featured->item_flash == 1): ?><del class="price-old"><?php echo e($allsettings->site_currency_symbol); ?><?php echo e($featured->regular_price); ?></del><?php endif; ?>
                <?php else: ?>
                <span class="text-accent"><?php echo e(Helper::translation(2992,$translate,'')); ?></span>
                <?php endif; ?>
                </div>
              </div>
            </div>
...
<?php endif; ?><?php /**PATH /var/www/html/doptor/resources/views/service/homepage.blade.php ENDPATH**/ ?>