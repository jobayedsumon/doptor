<header class="bg-light box-shadow-sm navbar-sticky">
        ...
        <div class="container">
          ...
          <div class="topbar-text dropdown d-md-none ml-auto"><a class="topbar-link dropdown-toggle" href="#" data-toggle="dropdown"><?php echo e(Helper::translation(3018,$translate,'')); ?> / <?php echo e(Helper::translation(2910,$translate,'')); ?><?php if($allsettings->site_blog_display == 1): ?> / <?php echo e(Helper::translation(2877,$translate,'')); ?><?php endif; ?></a>
            <ul class="dropdown-menu dropdown-menu-right">
                 <li><a class="dropdown-item" href="<?php echo e(route('service.home')); ?>"><i class=" text-muted mr-2"></i>Switch to Service</a></li>
              ...
              <li><a class="dropdown-item" href="<?php echo e(URL::to('/manage-services')); ?>"><i class="dwg-document text-muted mr-2"></i>Manage Services</a></li>
              <?php endif; ?>
              <?php endif; ?>
          ...
          <div class="d-none d-md-block ml-3 text-nowrap">
                <a class="topbar-link ml-3 pl-3 d-none d-md-inline-block" href="<?php echo e(route('service.home')); ?>"><i class="mt-n1"></i>Switch to Service</a>
          <?php if($addition_settings->verify_mode == 1): ?>
          ...
          <a class="topbar-link ml-3 pl-3 border-left border-light d-none d-md-inline-block" href="<?php echo e(URL::to('/manage-services')); ?>"><i class="dwg-document mt-n1"></i>Manage Services</a>
          <?php endif; ?>
          <?php endif; ?>
          <?php endif; ?>
          ...
          <?php endif; ?>
            <div class="navbar-toolbar d-flex align-items-center order-lg-3">
              <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarCollapse"><span class="navbar-toggler-icon"></span></button><a class="navbar-tool d-none d-lg-flex" href="#searchBox" data-toggle="collapse" role="button" aria-expanded="false" aria-controls="searchBox"><span class="navbar-tool-tooltip"><?php echo e(Helper::translation(4857,$translate,'')); ?></span>
                ...
                <a class="dropdown-item d-flex align-items-center" href="<?php echo e(URL::to('/manage-services')); ?>"><i class="dwg-document opacity-60 mr-2"></i>Manage Services</a>
    ...
    </header><?php /**PATH /var/www/html/doptor/resources/views/header.blade.php ENDPATH**/ ?>