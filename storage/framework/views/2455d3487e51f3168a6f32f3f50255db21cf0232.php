<aside id="left-panel" class="left-panel">
                ...
                <ul class="nav navbar-nav">
                   ...
                   <li class="menu-item-has-children dropdown">
                    ...
                    <?php if(in_array('items',$avilable)): ?>
                            <li class="menu-item-has-children dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-location-arrow"></i>Category Management</a>
                                <ul class="sub-menu children dropdown-menu">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            ...
                            <li><i class="menu-icon fa fa-location-arrow"></i><a href="<?php echo e(url('/admin/deposit')); ?>"><?php echo e(Helper::translation('61b32a5049abd',$translate,'Deposit')); ?></a></li>
                        </ul>
                    </li>
                        <li class="menu-item-has-children dropdown">
    ...
    </aside><?php /**PATH /var/www/html/doptor/resources/views/admin/navigation.blade.php ENDPATH**/ ?>