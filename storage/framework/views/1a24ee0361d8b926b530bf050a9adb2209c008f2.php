...
<script src="<?php echo e(URL::to('resources/views/admin/template/dropzone/min/dropzone.min.js')); ?>" type="text/javascript"></script><?php /**PATH /var/www/html/doptor/resources/views/admin/javascript.blade.php ENDPATH**/ ?>