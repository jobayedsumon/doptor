            ...
            <section class="col-lg-8 pt-lg-4 pb-4 mb-3">
                <div class="pt-2 px-4 pl-lg-0 pr-xl-5">
                    <div class="row border-bottom">
                        <h2 class="h3 pt-2 pb-4 mb-0 col pull-left">Manage Services<span class="badge badge-secondary font-size-sm text-body align-middle ml-2"><?php echo e(count($itemData['item'])); ?></span></h2>         <div class="col pull-right">
                            <a href="<?php echo e(URL::to('/service/create')); ?>" class="btn btn-primary btn-sm dropbtn"><span class="dwg-add"></span> Create Service</a>
...
</div><?php /**PATH /var/www/html/doptor/resources/views/service/my-services.blade.php ENDPATH**/ ?>