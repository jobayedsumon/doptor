...
<?php if($addition_settings->subscription_mode == 0): ?>
    <?php echo $__env->make('service.create-my-service', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php else: ?>
...
<?php endif; ?><?php /**PATH /var/www/html/doptor/resources/views/service/create-service.blade.php ENDPATH**/ ?>