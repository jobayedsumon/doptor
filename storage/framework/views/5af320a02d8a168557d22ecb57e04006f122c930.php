      ...
      <div class="container">
        ...
        <div class="topbar-text dropdown d-md-none ml-auto"><a class="topbar-link dropdown-toggle" href="#" data-toggle="dropdown"><?php echo e(Helper::translation(3018,$translate,'')); ?> / <?php echo e(Helper::translation(2910,$translate,'')); ?><?php if($allsettings->site_blog_display == 1): ?> / <?php echo e(Helper::translation(2877,$translate,'')); ?><?php endif; ?></a>
          <ul class="dropdown-menu dropdown-menu-right">
               <li><a class="dropdown-item" href="/doptor"><i class=" text-muted mr-2"></i>Switch to Product</a></li>
            <?php if($addition_settings->verify_mode == 1): ?> 
            <li><a class="dropdown-item" href="<?php echo e(URL::to('/verify')); ?>"><i class="dwg-check text-muted mr-2"></i><?php echo e(Helper::translation('614d4f7745243',$translate,'Verify Purchase')); ?></a></li>
            <?php endif; ?>
            <?php if(Auth::guest()): ?>
        ...
        <div class="d-none d-md-block ml-3 text-nowrap">
              <a class="topbar-link ml-3 pl-3 d-none d-md-inline-block" href="/doptor"><i class="mt-n1"></i>Switch to Product</a>
        <?php if($addition_settings->verify_mode == 1): ?>
        <a class="topbar-link ml-3 pl-3 d-none d-md-inline-block" href="<?php echo e(URL::to('/verify')); ?>"><i class="dwg-check mt-n1"></i><?php echo e(Helper::translation('614d4f7745243',$translate,'Verify Purchase')); ?></a>
        <?php endif; ?>
        <?php if($allsettings->site_selling_display == 1): ?>
        <?php if(Auth::guest()): ?>
        <a class="topbar-link ml-3 pl-3 border-left border-light d-none d-md-inline-block" href="<?php echo e(URL::to('/start-selling')); ?>"><i class="dwg-cart mt-n1"></i><?php echo e(Helper::translation(3018,$translate,'')); ?></a>
        <?php else: ?>
        <?php if(Auth::user()->user_type == 'vendor'): ?>
        <a class="topbar-link ml-3 pl-3 border-left border-light d-none d-md-inline-block" href="<?php echo e(URL::to('/manage-item')); ?>"><i class="dwg-cart mt-n1"></i><?php echo e(Helper::translation(3018,$translate,'')); ?></a>
        <?php endif; ?>
        <?php endif; ?>
        <?php endif; ?>
    ...
    <div class="navbar-sticky">
      <div class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <a class="navbar-brand d-sm-none mr-2 order-lg-1" href="<?php echo e(URL::to('/')); ?>" style="min-width: 4.625rem;">
           <img width="90" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($allsettings->site_logo); ?>" alt="<?php echo e($allsettings->site_title); ?>"/>
        </a>
        <?php endif; ?>
                ...
                <div class="widget widget-cart px-3 pt-2 pb-3">
                  <div data-simplebar data-simplebar-auto-hide="false">
                    ...
                    <div class="widget-cart-item pb-2 mb-2 border-bottom">
                      ...
                      <img width="40" src="<?php echo e(url('/')); ?>/public/storage/users/<?php echo e($msg->user_photo); ?>" alt="<?php echo e($msg->username); ?>" class="rounded-circle"/>
                      <?php else: ?>
                      <img width="40" src="<?php echo e(url('/')); ?>/public/img/no-image.png" alt="<?php echo e($msg->username); ?>" class="rounded-circle"/>
                      <?php endif; ?>
                      </a>
        ...
        <div class="card pt-2 pb-4 border-0 rounded-0">
          <div class="container">
            <div class="input-group-overlay">
              ...
              <input class="form-control prepended-form-control" type="text" name="product_item" id="product_item_top" placeholder="Search your services...">
              </form>
            </div>
          </div>
        </div>
      ...
      <div class="navbar-collapse collapse" id="main-nav-1">
        <ul class="navbar-nav flex-wrap">
          <?php $__empty_1 = true; $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <li class="nav-item dropdown position-static m-2"><a href="#" class="nav-link dropdown-toggle py-0 text-dark" data-toggle="dropdown" data-target="#"><?php echo e($category->category_name); ?></a>
              <div class="dropdown-menu w-100 top-auto" style="top: auto">
                <div class="container">
                  <div class="row w-100 pt-3">
                    <div class="col-6">
                      <div class="row">
                        <?php $__empty_2 = true; $__currentLoopData = $category->SubCategory; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $subcategory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_2 = false; ?>
                        <div class="col-6">
                          <a href="#" class="nav-link dropdown-toggle py-0 text-dark m-2" data-toggle="dropdown" data-target="#"><?php echo e($subcategory->subcategory_name); ?></a>
                        </div>
...
<?php /**PATH /var/www/html/doptor/resources/views/service/service-header.blade.php ENDPATH**/ ?>