...
<footer class="bg-dark pt-5">
      <div class="container pt-2 pb-3">
        <div class="row">
          <div class="col-md-4 text-center text-md-left mb-4">
            ...
            <img class="d-block" width="150" src="<?php echo e(url('/')); ?>/public/storage/settings/<?php echo e($additional->site_footer_logo); ?>" alt="<?php echo e($allsettings->site_title); ?>"/>
            <?php endif; ?>
            </a>
            </div>
            ...
            <h6 class="mr-3"><span class="text-primary"><?php echo e($total_files); ?> </span><span class="font-weight-normal text-white"><?php echo e(Helper::translation(3003,$translate,'')); ?></span></h6>
            <h6 class="mr-3"><span class="text-primary"><?php echo e($total_services); ?> </span><span class="font-weight-normal text-white">Services</span></h6>
            <h6 class="mr-3"><span class="text-primary"><?php echo e($service_orders); ?> </span><span class="font-weight-normal text-white">Orders</span></h6>
          ...
          <div class="col-md-2 d-none d-md-block text-center text-md-left mb-4">
            <div class="widget widget-links widget-light pb-2">
              ...
              <ul class="widget-list">
                ...
                <li class="widget-list-item"><a class="widget-list-link" href="<?php echo e(URL::to('/service/category/')); ?>/<?php echo e($maincategory->category_slug); ?>"><?php echo e($maincategory->category_name); ?></a></li>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              </ul>
            </div>
          </div>
          ...
          <div class="col-md-4">
            ...
            <img src="<?php echo e(asset('public/img/Payment_gateway_Logo.png')); ?>" width="400px"/>
          </div>
          <?php endif; ?>
        </div>
      </div>
      <div class="pt-4 bg-darker">
        <div class="container">
          <div class="d-md-flex justify-content-between row">
            <div class="col-md-6 pb-4 font-size-xs text-light opacity-50 text-center text-md-left">&copy; <?php echo e(date('Y')); ?>  <?php echo e($allsettings->site_title); ?></div>
            <div class="col-md-6 widget widget-links widget-light pb-4">
    ...
    <?php endif; ?>
    <a class="btn-scroll-top" href="#top" data-scroll><span class="btn-scroll-top-tooltip text-muted font-size-sm mr-2"><?php echo e(Helper::translation(5976,$translate,'')); ?></span><i class="btn-scroll-top-icon dwg-arrow-up"></i></a><?php /**PATH /var/www/html/doptor/resources/views/footer.blade.php ENDPATH**/ ?>