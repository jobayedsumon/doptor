...
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::to('resources/views/admin/template/dropzone/min/dropzone.min.css')); ?>"><?php /**PATH /var/www/html/doptor/resources/views/admin/stylesheet.blade.php ENDPATH**/ ?>