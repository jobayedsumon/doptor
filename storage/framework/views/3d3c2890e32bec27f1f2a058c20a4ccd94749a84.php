<div class="cz-sidebar-static rounded-lg box-shadow-lg px-0 pb-0 mb-5 mb-lg-0">
            ...
            <li class="border-bottom mb-0"><a class="nav-link-style d-flex align-items-center px-4 py-3" href="<?php echo e(URL::to('/manage-services')); ?>"><i class="dwg-document opacity-60 mr-2"></i>Manage Services</a></li>
           ...
           </div><?php /**PATH /var/www/html/doptor/resources/views/dashboard-menu.blade.php ENDPATH**/ ?>