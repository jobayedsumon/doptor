...
/// Shurjopay Payment Code Starts ////
    public function shurjopay($data){
        global $db;
        global $site_url;
        global $dir;

        require_once $dir.'/shurjopay/shurjoPay.php';

        $this->insert_temp_order($data,"","shurjopay");
        ...
        // Merchant Return URL
        $return_url = $site_url.'/shurjopay-return.php';
        ...
        $payload = array(
            ...
            // Order information
            'prefix' => 'JNK',
            'order_id' => (string) $data['reference_no'],
            'discsount_amount' => 0,
            'disc_percent' => 0,
            // Customer information
            'client_ip' => '127.0.0.1',
            'customer_name' =>  $login_seller_user_name,
