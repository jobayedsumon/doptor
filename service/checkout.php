				...
				<div class="col-md-12 mb-3">
					<div class="card payment-options">
						...
						<div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-1">
                                        <input id="shurjopay" type="radio" name="method" class="form-control radio-input"
                                            checked>
                                    </div>
                                    <div class="col-11">
                                        <img src="images/shurjopay.png" height="50" class="ml-2 width-xs-100">
                                    </div>
                                </div>
		...
		<div class="col-md-5">
			<div class="card checkout-details">
				...
				<div class="card-body">
                    ...
                    <h5 class="font-weight-bold">
                        <span class="float-right my-2"><?= ($total * 86.32); ?> BDT</span>
                    </h5>
					<hr>
